...
function generateArticles() {
    const articlesContainer = document.querySelector('.articles-container'); // Add this class to your <main> element
    ...
    articles.forEach(article => {
        ...
        const articleHTML = `
            ...
            <section class="post-content">
                ...
                <p>${article.description}</p> <a href="#">Read More...</a>
            </section>
        `;
...
generateArticles(); // Call the function to generate and display the articles.